...
public interface BetMapper {
    ...
    @Select("select 0-SUM(win_lose) from sys_bet_info where table_id = #{tableId} and boot_num = #{bootNum} and version = #{version} and type in(0,1)")
    BigDecimal getWinLose(SysTableManagement sysTableManagement);

    @Select("select 0-SUM(win_lose) from sys_bet_info where table_id = #{tableId} and boot_num = #{bootNum} and version = #{version} and type = 4")
    ...
    @Select("select 0-SUM(win_lose) from sys_bet_info where table_id = #{tableId} and boot_num = #{bootNum} and version = #{version} and type in(2,3)")
    BigDecimal getWinLoseTh(SysTableManagement sysTableManagement);

    @Select("select 0-SUM(win_lose) from sys_bet_info where table_id = #{tableId} and boot_num = #{bootNum} and version = #{version} and type = 5")
    ...
    @Select("select 0-SUM(win_lose) from sys_bet_info where table_id = #{tableId} and version = #{version} and type in(0,1)")
    BigDecimal getReceiptWinLose(SysTableManagement sysTableManagement);

    @Select("select 0-SUM(win_lose) from sys_bet_info where table_id = #{tableId} and version = #{version} and type = 4 ")
    ...
    @Select("select 0-SUM(win_lose) from sys_bet_info where table_id = #{tableId} and version = #{version} and type in(2,3)")
    BigDecimal getReceiptWinLoseTh(SysTableManagement sysTableManagement);

    @Select("select 0-SUM(win_lose) from sys_bet_info where table_id = #{tableId} and version = #{version} and type = 5")
