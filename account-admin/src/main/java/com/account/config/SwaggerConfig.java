...
//                .apis(RequestHandlerSelectors.basePackage("com.account.controller"))
                .apis(Predicates.or(
                        ...
                        RequestHandlerSelectors.basePackage("com.account.controller.report")
                ))
    ...
    private ApiInfo apiInfo() {
        ...
        return new ApiInfoBuilder()
                // 设置标题
                .title("账房系统Swagger接口文档")
                // 描述
                .description("描述：方便开发人员对接接口......")
                // 作者信息
                .contact(new Contact(accountConfig.getName(), null, null))
                // 版本
                .version("版本号:" + accountConfig.getVersion())
                .build();
    }
}
